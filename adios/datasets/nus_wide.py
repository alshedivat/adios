"""
An interface to the NUS-WIDE multi-label datasets.
...
class NUS_WIDE(MLCDataset):
    ...
    def __init__(self, which_set, only_labels=False,
        ...
        # Quick sanity checks
        n_labels = n_labels or 81
        assert 0 < n_labels <= 81

        # Dataset parameters
        self.n_features = 500
        self.n_labels = n_labels

        datadir = os.path.join(os.environ['DATA_PATH'], 'NUS-WIDE')
        super(NUS_WIDE, self).__init__(datadir, which_set,
            n_labels=n_labels,
